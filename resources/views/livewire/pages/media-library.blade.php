<div class="media-library-container space-y-6">
	...
	<div wire:loading.remove>
		...
		@else
			{{-- Media Grid --}}
			<div
				class="p-4 {{ $viewMode === 'grid' ? 'grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4' : 'flex flex-col gap-2' }}"
				wire:key="media-grid-area">
