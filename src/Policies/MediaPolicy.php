...
class MediaPolicy
{
    ...
    {
        /**
         * Filters the capability slug used to check whether the user can restore a media item.
         *
         * @since 1.0.0
         *
         * @param string $default Default capability slug. Default 'media.delete'.
    ...
    {
        /**
         * Filters the capability slug used to check whether the user can permanently delete a media item.
         *
         * @since 1.0.0
         *
         * @param string $default Default capability slug. Default 'media.delete'.
