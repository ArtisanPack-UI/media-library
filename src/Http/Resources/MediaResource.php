...
class MediaResource extends JsonResource
{
    ...
    public function toArray( Request $request ): array
    {
        return [
            ...
            'optimization' => [
                'status'        => $this->optimization_status,
                'optimized_at'  => $this->optimized_at?->toIso8601String(),
                'bytes_saved'   => $this->optimization_bytes_saved,
                'original_size' => $this->optimization_original_size,
                'formats'       => $this->optimization_formats,
                'error'         => $this->optimization_error,
            ],
            'folder'      => [
                'id'   => $this->folder_id,
